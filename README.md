# Kernel OpenSource for realme devices with Snapdargon 865/870
...
- rui5.0, work on Android 14 with realme UI 5.0, origin-url: 
    ...
    `realme GT Exp. Master Edition(RMX3366, device:RE546F, prjname:21615) Only Chinese Variant`
    ...
    `realme GT Neo3T(model:RMX3371, device: RE54E5L1, prjname:21733) Global Variant`
